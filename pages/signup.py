...
import pymongo
conn=pymongo.MongoClient("mongodb+srv://ajay08singhmunda_db_user:PKQROAajnfpfBQOB@cluster0.whgecul.mongodb.net/?appName=Cluster0")#Set the connection with mongo database and our code
